...
const DataTablem = () => {
  ...
  const cards = [
    ...
    { id: 5, title: 'SIMS 1', content: 'This is the content of card 4.' },
    { id: 6, title: 'SIMS 2', content: 'This is the content of card 4.' },
  ];
...
const columns = [
  ...
  { field: 'CH4', headerName: 'SIMS 1', headerAlign: 'center', align: 'center', flex: 1 },
  { field: 'CH5', headerName: 'SIMS 2', headerAlign: 'center', align: 'center', flex: 1 },
];
  ...
  return (
    <div className="min-h-screen bg-[#2C2A3C] p-1 font-sans">
      <header className="mb-4 p-5 h-[20px] bg-[#242038] border-[1px] border-[#6B7280] rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4">
        <h1 className="text-sm font-semibold ml-5 text-white"> ❄️ Total Chilled Water Flow</h1>
