...
const Sidebar: React.FC = () => {
  ...
  const [clientSpecificTemplatesOpen, setClientSpecificTemplatesOpen] =
    useState(false);
                  ...
                  <Link
                    to={
                      item === 'Portfolio Summary'
                        ? '/'
                        : item === 'Asset Insights'
                          ? '/plant/assets' // Redirect to specific path for Portfolio Summary
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <div
                    className="flex justify-between items-center hover:text-green-400 cursor-pointer"
                    onClick={() =>
                      handleTemplateToggle('clientSpecificTemplates')
                    }
                  >
